...
import { CustomText, SectionTitle } from '../others';
      ...
      return (
          <View style={[styles.listExtraModalView, {paddingBottom: bottom}]}>
            ...
            <AsyncOperationStatusIndicator
              ...
              loadingLayout={<LoadingLayoutHorizontalItemsFlatlist horizontal={true} contentContainerStyle={styles.listContainerHeader}/>}
            >
                <FlatList
                  horizontal={true}
